...
```
$ git clone https://github.com/andreas-sujono/go-basic-projects/go-rest-boilerplate.git
...
This project is licensed under the MIT License. See the [LICENSE](https://github.com/andreas-sujono/go-basic-projects/go-rest-boilerplate/blob/master/LICENSE) file for details.


## Goals
- multiple usecase (service), schema, controller, routes
- middleware
- postgresql (ORM, migrations, transactions)
...
- read cookie, headers
- file upload
- rate limit, helmet, CSRF
- axios

- request validation (pipes)
- auth, role guard --> ecnryption, hashing
- cache (in memory & redis)
- queue (listen and publish) --> redis bullmq
- pub sub (redis)
- microservervice architecture

- websocket

- see how thread blocking works
- how to get from private repo